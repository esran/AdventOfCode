...
pub fn check_example<T>(day: i32, example: i32, context: &mut T, func: &dyn Fn(&str, &mut T) -> i32) {
...
pub fn run_version<T>(day: i32, version: i32, context: &mut T, func: &dyn Fn(&str, &mut T) -> i32) {
